...
graph TD
    ...
    subgraph Provider
       RobotCore -.-> Messenger
       Directive --> |select provider for feature| Messenger
        
    end
%%%%      RobotCore --->|gets from Directive| Feature
%%%%      RobotCore -->|can return an| Answer
%%      Directive ---> handleDirective
%%      Directive --> Feature & args

%%      handleDirective --->|updates | Messenger
%%%%      Provider -->| responds to | RobotCore
%%%%      RobotCore ---> handleDirective
%%%%      Directive -->|given to| RobotCore
%%%%      Tool -->| builds item for | RobotCore
%%%%      Messenger -.->| provides messages | ProviderMessage
%%%%      Feature -.->| provides feature | Messenger
%%      Tools -.->| provides tools | Messenger

%%%%      RobotCore --> |requests| Messenger
%%      Messenger --> |that is given to | Provider
%%   end
